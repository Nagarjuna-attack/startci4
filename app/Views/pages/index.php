...
<?= $this->section('content'); ?>
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="/assets/img/hmi1.png" alt="" />
                <div class="flex-caption">
                    <h3 style="color: green;">KOMISARIAT UNIVERSITAS DIPANEGARA</h3> 
					<p>Opportunities don't happen. You create them</p> 
					 
                </div>
              </li>
              <li>
                <img src="/assets/img/hmi2.png" alt="" />
                <div class="flex-caption">
                    <h3 style="color: green;" >HIMPUNAN MAHASISWA ISLAM</h3> 
